...
const StatCard: React.FC<StatCardProps> = ({
  ...
  const iconBg =
    ...
    'dark:bg-blue-950/45 dark:text-blue-400';
  ...
  return (
    <div className={`relative group overflow-hidden rounded-xl border-l-4 transition-all duration-300 cursor-default
                     ...
                     dark:bg-[var(--dm-surface-popover)] dark:border-[var(--dm-border)] ${borderAccent} dark:hover:border-[var(--dm-border)]`}>
        ...
        <div className="flex items-start justify-between">
          <div className="min-w-0 flex-1">
            ...
            <h3 className="text-3xl font-black text-slate-900 tracking-tight leading-none
                           dark:text-[var(--dm-text-primary)] dark:font-mono dark:tabular-nums">
