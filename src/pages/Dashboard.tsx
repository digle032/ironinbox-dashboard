            ...
            {stats.topThreats.length === 0 ? (
              ...
              <div className="space-y-3">
                {stats.topThreats.map(([domain, count], index) => (
                  <div key={domain} className="flex items-center space-x-4 p-3 bg-slate-50/50 /50 rounded-xl border border-slate-100  hover:border-blue-200  transition-all group">
