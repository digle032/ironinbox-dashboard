    ...
    <>
      ...
      <div className="p-6 space-y-4 bg-slate-50 min-h-screen max-w-7xl mx-auto dark:bg-[#040c18]">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:bg-[#0a1628] dark:border-[#0f2a4a]">
          ...
          {/* Table toolbar */}
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-slate-100 dark:border-[#0f2a4a] bg-white dark:bg-[#0a1628]">
            <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-400 dark:text-[#2a4a6a] dark:font-mono">
              ...
              <button
                ...
                className={clsx(
                  ...
                  hasActiveFilter
                    ...
                    : 'border-slate-200 bg-white text-slate-600 hover:bg-slate-50 dark:bg-[#0a1628] dark:border-[#0f2a4a] dark:text-[#94a3b8] dark:hover:bg-[#0f2040]'
                )}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
